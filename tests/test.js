...
describe('/login', () => {
  test('簡易ログインするとき、クッキーをセットし/mainへリダイレクトする', () =>
    request
      .agent(app)
      .post('/login')
      .send({ name: 'taro', icon: 'hoge.js' })
      .expect('Set-Cookie', /mdOneMinEx=j%3A%7B%22name%22%3A%22taro%22%2C%22icon%22%3A%22hoge.js%22%7D;/)
...
describe('/main', () => {
  ...
  const cookie = `mdOneMinEx=j%3A%7B%22name%22%3A%22taro%22%2C%22icon%22%3A%22hoge.js%22%7D; Max-Age=${
